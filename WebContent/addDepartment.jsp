...
<body style="text-align: center;">
	...
	<c:choose>
		<c:when test="${isValidUser && not empty isValidUser}">
				...
				<table align="center"
					...
					<tr>
						...
						<td align="center"><button
								onclick="location.href='${pageContext.request.contextPath}/success.jsp'" type="button">Back</button></td>
					</tr>
			...
			<button onclick="location.href='${pageContext.request.contextPath}/logout'" type="button">Log
				out</button>
